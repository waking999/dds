...
import au.edu.cdu.common.order.VertexPriority;
...
public class GreedyVoteGr implements ITask, IGreedyDS<Integer> {
	...
	private void initialization() {
		...
		dominatedMap = new HashMap<>(this.numOfVertices);
		voteMap = new HashMap<>(this.numOfVertices);
		weightMap = new HashMap<>(this.numOfVertices);
	...
	private void greedy() {
		...
		this.dominatingSet = AlgoUtil.grasp(this.g, this.dominatingSet);
