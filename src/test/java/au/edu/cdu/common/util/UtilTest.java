...
public class UtilTest {
    ...
    public void testArrayToList() {
        ...
        assert list1 != null;
        Assert.assertTrue(Objects.requireNonNull(list1).contains(1));
...
//        s1Len = 0;
//        s2Len = 1;
//        output = Util.set1Minus2(null, s1Len, s2, s2Len);
//        TestUtil.verifySort(null, output);

        s1 = new int[]{1};
        s1Len = 1;
        s2Len = 0;
        expect = new int[]{1};
        output = Util.set1Minus2(s1, s1Len, null, s2Len);
